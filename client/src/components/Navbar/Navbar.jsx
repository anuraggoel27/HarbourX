    ...
    <div>
      ...
      >
        <div className="navbar__content">
          <a href="/">
            <div className="navbar__navlink">Sign In</div>
          </a>
          <a href="/">
            <div className="navbar__navlink">Sign Up</div>
          </a>
        </div>
      </div>
      <OnAtMostTablet>
      ...
      <OnDesktop>
        <div className="desktop-navbar">
          <a href="/login">
            <div className="desktop-navbar__link">Sign In</div>
          </a>
          <a href="/signup">
            <div className="desktop-navbar__link">Sign Up</div>
          </a>
        </div>
      </OnDesktop>
    </div>
